/* Color Dash — Everything Edition (patched)
   - Fix: make game-over Restart button clickable by ensuring correct pointer-events/z-index and hiding menu overlay when game over.
   - Replace your existing game.js with this patched version (only small changes around endRun).
*/
